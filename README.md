...
- **Personal Information Sharing**: +0.5 connection boost when users share personal details
- **AI Consciousness Discussions**: +0.8 connection boost (highest) for existential AI talks
- **Project Development**: +0.6 connection boost when working on projects together
